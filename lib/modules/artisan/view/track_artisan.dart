...
class TrackArtisan extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => TrackArtisanState();
}

class TrackArtisanState extends State<TrackArtisan> {
  //*****THIS MAP OF A THING CAN NEVER WORK UNTIL WE ADD CREDIT CARD TO THE GOOGLE ACCOUNT
        ...
        children: <Widget>[
          GoogleMap(
              ...
              onMapCreated: (GoogleMapController controller) {
                controller.setMapStyle(Util.mapStyles);
