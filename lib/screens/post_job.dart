      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: Text(
                'Post a job in ${Constants.appName} community and get artisan around you notified and bid your job offer and you choose your prefered artisan based ib ratings and reviewsa',
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 16.0,
                ),
          ...
          Card(
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  errorText:
                      postJob.address ? 'Job address can not be empty' : null,
                  contentPadding: EdgeInsets.all(10.0),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(5.0),
                    borderSide: BorderSide(
